 ...
 */
define('APPPATH', realpath(__DIR__.'/../../komakilog/fuel/app/').DIRECTORY_SEPARATOR);

/**
 * Path to the default packages directory.
 */
define('PKGPATH', realpath(__DIR__.'/../../komakilog/fuel/packages/').DIRECTORY_SEPARATOR);

/**
 * The path to the framework core.
 */
define('COREPATH', realpath(__DIR__.'/../../komakilog/fuel/core/').DIRECTORY_SEPARATOR);
